...
[![Tests](https://img.shields.io/badge/tests-929%20passed-brightgreen.svg)]()
...
```bash
make test        # <!-- counts:tests -->929<!-- /counts:tests --> tests
...
| `make test`        | Run <!-- counts:tests -->929<!-- /counts:tests --> tests    |
