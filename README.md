# Rick MCP Server <!-- counts:version -->v3.15<!-- /counts:version -->
...
[![Tests](https://img.shields.io/badge/tests-944%20passed-brightgreen.svg)]()
...
```bash
make test        # <!-- counts:tests -->944<!-- /counts:tests --> tests
...
| `make test`        | Run <!-- counts:tests -->944<!-- /counts:tests --> tests    |
...
| `make rick-ollama` | Bake Rick into a local Ollama model ([guide](docs/ollama-rick.md)) |
