...
[![Tests](https://img.shields.io/badge/tests-873%20passed-brightgreen.svg)]()
...
```bash
make test        # <!-- counts:tests -->873<!-- /counts:tests --> tests
...
| `make test`        | Run <!-- counts:tests -->873<!-- /counts:tests --> tests    |
