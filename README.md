...
[![Tests](https://img.shields.io/badge/tests-919%20passed-brightgreen.svg)]()
...
```bash
make test        # <!-- counts:tests -->919<!-- /counts:tests --> tests
...
| `make test`        | Run <!-- counts:tests -->919<!-- /counts:tests --> tests    |
