...
[![Tests](https://img.shields.io/badge/tests-917%20passed-brightgreen.svg)]()
...
```bash
make test        # <!-- counts:tests -->917<!-- /counts:tests --> tests
...
| `make test`        | Run <!-- counts:tests -->917<!-- /counts:tests --> tests    |
