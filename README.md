...
[![Tests](https://img.shields.io/badge/tests-924%20passed-brightgreen.svg)]()
...
```bash
make test        # <!-- counts:tests -->924<!-- /counts:tests --> tests
...
| `make test`        | Run <!-- counts:tests -->924<!-- /counts:tests --> tests    |
