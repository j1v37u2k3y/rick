...
[![Tests](https://img.shields.io/badge/tests-866%20passed-brightgreen.svg)]()
...
```bash
make test        # <!-- counts:tests -->866<!-- /counts:tests --> tests
...
| `make test`        | Run <!-- counts:tests -->866<!-- /counts:tests --> tests    |
